...
public:
	...
	HashMap<TKey, TValue *> get_const(TightLocalVector<TKey> p_keys = TightLocalVector<TKey>()) const;
	HashMap<TKey, TValue *> get(TightLocalVector<TKey> p_keys = TightLocalVector<TKey>());
